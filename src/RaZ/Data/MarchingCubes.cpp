...
uint8_t computeCellConfiguration(const Grid3b& grid, std::size_t widthIndex, std::size_t heightIndex, std::size_t depthIndex) {
  ...
  //     | (static_cast<uint8_t>(grid.getValue(widthIndex + 1, heightIndex,     depthIndex    )) << 1)  // Bottom-right front
  //     | (static_cast<uint8_t>(grid.getValue(widthIndex + 1, heightIndex + 1, depthIndex    )) << 2)  // Top-right front
  //     | (static_cast<uint8_t>(grid.getValue(widthIndex,     heightIndex + 1, depthIndex    )) << 3)  // Top-left front
  //     | (static_cast<uint8_t>(grid.getValue(widthIndex,     heightIndex,     depthIndex + 1)) << 4)  // Bottom-left back
  //     | (static_cast<uint8_t>(grid.getValue(widthIndex + 1, heightIndex,     depthIndex + 1)) << 5)  // Bottom-right back
  //     | (static_cast<uint8_t>(grid.getValue(widthIndex + 1, heightIndex + 1, depthIndex + 1)) << 6)  // Top-right back
  //     | (static_cast<uint8_t>(grid.getValue(widthIndex,     heightIndex + 1, depthIndex + 1)) << 7); // Top-left back
  ...
  return (static_cast<uint8_t>(grid.getValue(widthIndex,     heightIndex,     depthIndex + 1)))       // Bottom-left back
       | (static_cast<uint8_t>(grid.getValue(widthIndex + 1, heightIndex,     depthIndex + 1)) << 1)  // Bottom-right back
       | (static_cast<uint8_t>(grid.getValue(widthIndex + 1, heightIndex,     depthIndex    )) << 2)  // Bottom-right front
       | (static_cast<uint8_t>(grid.getValue(widthIndex,     heightIndex,     depthIndex    )) << 3)  // Bottom-left front
       | (static_cast<uint8_t>(grid.getValue(widthIndex,     heightIndex + 1, depthIndex + 1)) << 4)  // Top-left back
       | (static_cast<uint8_t>(grid.getValue(widthIndex + 1, heightIndex + 1, depthIndex + 1)) << 5)  // Top-right back
       | (static_cast<uint8_t>(grid.getValue(widthIndex + 1, heightIndex + 1, depthIndex    )) << 6)  // Top-right front
       | (static_cast<uint8_t>(grid.getValue(widthIndex,     heightIndex + 1, depthIndex    )) << 7); // Top-left front
}
