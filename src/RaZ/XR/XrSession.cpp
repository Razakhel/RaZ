...
#include "GL/glx.h" // TODO: check if useful
#endif
...
void XrSession::begin(XrViewConfigurationType viewConfigType) {
...
void XrSession::renderFrame(const std::vector<XrViewConfigurationView>& viewConfigViews,
  ...
  if (isSessionActive && frameState.shouldRender && renderLayer(renderLayerInfo, viewConfigViews, viewConfig))
