...
//  2018-03-06: OpenGL: Added const char* glsl_version parameter to ImGui_ImplGlfw_Init() so user can override the GLSL version e.g. "#version 150".
...
//  2018-02-16: Misc: Obsoleted the io.RenderDrawListsFn callback and exposed ImGui_ImplGlfw_RenderDrawData() in the .h file so you can call it yourself.
...
void ImGui_ImplGlfw_RenderDrawData(ImDrawData* draw_data)
{
...
bool    ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, const char* glsl_version)
{
    g_Window = window;
    g_Time = 0.0;
